...
function Car(type, color, numberOfDoors, doors, started) {
    this.color = color;
    this.type = type;
    this.started = typeof started === "boolean" ? started : false;
    //typeof vracia string
    ...
    this.toString = function () {
        return "Type:" + this.type + " Color:" + this.color +
            " Engine running:" + this.started; //doors
    };
...
var car2 = new Car("coupe", "black", 5, doors1, true);
//function Car(type, color, numberOfDoors, doors, started